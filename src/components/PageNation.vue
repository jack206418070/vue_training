<template>
  <ul v-if="pagination.total_pages > 1 && pagination.total_pages !== undefined" class="pagination d-flex align-items-center jy-content-center" :style="{backgroundColor: style.bg}">
